...
risk [https://doi.org/10.1093/eurheartj/ehy339]. Similarly, an algorithm for the
...
- Aim 1: *How to develop and present a prediction model to be used in clinical
  ...
  in practice.
- Aim 2: *How to use risk estimates from a prediction model to assess treatment
...
In **Chapter 2** we develop a model for the prediction of 5-year recurrence risk
...
In **Chapter 3** we develop a model for the prediction of 28-day mortality for
...
In **Chapter 4** we present the results of a scoping literature review of
...
In **Chapter 5** we develop a standardized scalable framework for the assessment
...
In **Chapter 6** we apply the standardized framework to evaluate effect
...
In **Chapter 7** we compare different risk-based methods for predicting
